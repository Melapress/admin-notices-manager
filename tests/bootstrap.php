...
if ( ! defined( 'ADMIN_NOTICES_MANAGER_DIR' ) ) {
	define( 'ADMIN_NOTICES_MANAGER_DIR', __DIR__ . '/' );
}
...
if ( ! defined( 'ADMIN_NOTICES_MANAGER_PATH' ) ) {
	define( 'ADMIN_NOTICES_MANAGER_PATH', 'path' );
}
