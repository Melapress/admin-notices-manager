...
module.exports = {
	...
	// Style options.
	styleSRC: './assets/css/admin/admin-style.scss', // Path to main .scss file.
	...
	// Translation options.
	textDomain: 'admin-notices-manager', // Your textdomain here.
	translationFile: 'admin-notices-manager.pot', // Name of the translation file.
